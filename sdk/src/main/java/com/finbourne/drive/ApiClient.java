...
public class ApiClient {
    ...
    private String basePath = "https://www.lusid.com/drive";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.1.351/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.lusid.com/drive
